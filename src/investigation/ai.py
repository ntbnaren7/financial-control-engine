...
class InvestigationEngine:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "For each individual hypothesis entry, these two arrays MUST be mutually exclusive — never place the same evidence ID in both arrays for the same hypothesis. "
            "If an evidence item has mixed implications for a hypothesis, assign it only to the array that best reflects its primary relationship to that hypothesis.\n"
