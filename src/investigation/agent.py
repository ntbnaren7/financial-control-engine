...
- You reference ONLY `evidence_id`s that appear inside the `evidence_records` list. 
- NEVER use an `observation_id` (e.g. ones starting with `obs_`) as an `evidence_id`.
