    ...
    <div className="min-h-screen text-white font-sans selection:bg-blue-500/30 selection:text-white relative bg-[#000000]">
      ...
      <section id="product" className="pt-40 pb-0 relative z-10 flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="max-w-[1200px] w-full mx-auto flex flex-col items-center text-center px-6 relative z-10"
        >
          ...
          <p className="mt-8 text-lg text-zinc-400 leading-relaxed max-w-2xl mx-auto font-medium">
        ...
        ========================================= */}
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8 z-20">
